package com.github.flamingsharky.newworld.common.registries.blocks;
...
public class PillarBlocks extends RotatedPillarBlock {
    public PillarBlocks(Properties p_55926_) {
        super(p_55926_);
    }
